# Otto - An AI concierge powered by Firecrawl for real-time web research and evidence gathering, and ElevenLabs for natural voice replies, live call prompts, and callback briefings.
